...
class ImageList(tk.LabelFrame):
    def __init__(self, master):
        ...
        self.import_but = tk.Button(self.button_frame, text='Import', command=self.imp)
        ...
        for i in range(0, 20):
            ...
            self.images_list.create_window(i*120, 0, window=radio, width=120, height=120)  # TODO Track ids returned
