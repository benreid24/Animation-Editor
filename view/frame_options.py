...
class FrameOptions(tk.LabelFrame):
    def __init__(self, master):
        ...
        self.up_button = tk.Button(self, text='Move Up', command=self.clone)
        self.down_button = tk.Button(self, text='Move Down', command=self.delete)
        ...
        self.len_update.grid(row=2, column=3)
